...
const FarmCards: React.FC = () => {
  ...
  const rows = farms.reduce<Farm[][]>((farmRows, farm) => {
    ...
    if (newFarmRows[newFarmRows.length - 1].length === 3) {
      if (farm.name === "Kimchi crunch" || farm.name === "Sushi swap" || farm.name === "Taco Tuesday" || farm.name === "Bal_Shrimp_Dai_95" || farm.name === "Bal_Shrimp_Dai_80" || farm.name === "Zombie Swamp" || farm.name === "DogeFi Days"){
      } else {
