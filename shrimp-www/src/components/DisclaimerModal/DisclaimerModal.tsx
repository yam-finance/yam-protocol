    ...
    if (step === 'disclaimer') {
      return (
        <div>
          ...
          <p>🚨 Shrimping Pools will end on 2020/08/18 17:07:40 UTC+0 (Please exit before that time) 🚨</p>
          <p>🦐 First Advanced Pool will start on 2020/08/18 20:20:20 UTC+0 (See the rules for the Advanced Pool) 🦐</p>
        </div>
      )
    } else {
      return (
