...
const Nav: React.FC = () => {
  return (
    <StyledNav>
      ...
      <StyledLink exact activeClassName="active" to="/farms">Shrimping Pools</StyledLink>
      <StyledLink exact activeClassName="active" to="/Adverts">Advanced pools</StyledLink>
